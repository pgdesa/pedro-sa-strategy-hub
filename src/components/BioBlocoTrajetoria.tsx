...
export const BioBlocoTrajetoria = ({ className = "" }: BioBlocoTrajetoriaProps) => {
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 min-h-screen flex items-center pt-24 pb-12">
        <div className="grid grid-cols-12 gap-8 lg:gap-12 w-full items-center">
          {/* Foto */}
          <div className="col-span-12 lg:col-span-6 flex items-center justify-center py-4 lg:py-0 order-2 lg:order-1 px-4 sm:px-6 md:px-8 lg:px-0">
          ...
          {/* Texto */}
          <div className="col-span-12 lg:col-span-6 space-y-4 sm:space-y-5 lg:space-y-6 z-10 order-1 lg:order-2 flex flex-col justify-center px-4 sm:px-6 md:px-8 lg:px-0">
