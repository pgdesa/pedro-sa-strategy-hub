...
export const SubHeroBlock = () => {
  const { sectionRef, elementRef: imageRef } = useParallax({ intensity: 50 });
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-surface via-background to-surface-elevated pointer-events-none" aria-hidden="true" />
        ...
        <div className="grid grid-cols-12 gap-6 lg:gap-8 items-center">
          ...
          <div data-photo className="col-span-12 lg:col-span-6 xl:col-span-6 animate-fade-in-delay order-1 lg:order-2 flex items-center justify-center relative">
            <div className="relative perspective-container w-full">
              {/* Rim light effect */}
              <div className="absolute -inset-12 bg-gradient-to-br from-primary/15 via-transparent to-accent/10 rounded-full blur-3xl pointer-events-none" aria-hidden="true" />
              <div className="absolute top-0 right-0 w-56 h-56 bg-primary/10 rounded-full blur-3xl pointer-events-none" aria-hidden="true" />
